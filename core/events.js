...
if(
typeof event?.intensityBefore!==“number”||
typeof event?.intensityAfter!==“number”
){
return null;
}

return(
  event.intensityBefore-
...
return normalize(events).filter(event=>{
  ...
  if(
    criteria.host&&
    event.host!==criteria.host
  ){
    return false;
  }
  if(
    criteria.intervention&&
    event.intervention!==criteria.intervention
  ){
    return false;
  }
  return true;
